...
namespace DAL.Models
{
    ...
    public partial class TageerEntities : DbContext
    {
        ...
        public virtual int SelectUsersByFilter(Nullable<int> skip, Nullable<int> take, Nullable<int> accountTypeId, Nullable<bool> isBlocked, Nullable<int> countryId, Nullable<System.DateTime> createDateFrom, Nullable<System.DateTime> createDateTo)
        {
            var skipParameter = skip.HasValue ?
                new ObjectParameter("skip", skip) :
                new ObjectParameter("skip", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SelectUsersByFilter", skipParameter, takeParameter, accountTypeIdParameter, isBlockedParameter, countryIdParameter, createDateFromParameter, createDateToParameter);
        }
